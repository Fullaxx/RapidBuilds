...
if [ "${ENABLE_NVIDIA_FOR_DOCKER}" == "1" ]; then
  ...
  verbosecopymodule ${PACKAGESDIR}/nvidia-container-runtime/nvrtd-${ARCH}-bksrc1.xzm ${MODSDIR}/
#  verbosecopymodule ${PACKAGESDIR}/nvidia-container-runtime/libnvidia-container-1.7.0-${ARCH}-1.xzm ${MODSDIR}/
#  verbosecopymodule ${PACKAGESDIR}/nvidia-container-runtime/nvidia-container-toolkit-1.7.0-${ARCH}-bksrc1.xzm ${MODSDIR}/
