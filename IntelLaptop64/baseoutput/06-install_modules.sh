...
# VSCode needs RDL
if [ "${INCVSCODE}" == "Y" ]; then
  verbosecopymodule ${PACKAGESDIR}/vscode/vscode-1.30.2-${ARCH}-1.xzm ${MODSDIR}/
fi
...
verbosecopymodule ${PACKAGESDIR}/chromium/chromium-72.0.3626.81-${ARCH}-1alien.xzm ${MODSDIR}/
...
verbosecopymodule ${PACKAGESDIR}/vivaldi/vivaldi-stable-2.3.1440.60-1.${ARCH}.xzm ${MODSDIR}/
