...
verbosecopymodule ${PACKAGESDIR}/nvidia_driver/${KERNVERS}/011-nvidia-535.104.05-${KERNVERS}.xzm ${BASEDIR}/

# Chrome needs RDL
if [ "${INCCHROME}" == "Y" ]; then
  verbosecopymodule ${PACKAGESDIR}/chrome/chrome-122.0.6261.128-x86_64-1.xzm ${MODSDIR}/
fi
...
verbosecopymodule ${PACKAGESDIR}/docker/docker-24.0.9-${ARCH}-1.xzm ${MODSDIR}/
