...
verbosecopymodule ${PACKAGESDIR}/nvidia_driver/${KERNVERS}/011-nvidia-535.161.07-${KERNVERS}.xzm ${BASEDIR}/
...
verbosecopymodule ${PACKAGESDIR}/docker/docker-25.0.5-${ARCH}-1.xzm ${MODSDIR}/
