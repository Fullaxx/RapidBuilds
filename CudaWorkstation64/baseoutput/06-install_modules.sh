...
verbosecopymodule ${PACKAGESDIR}/nvidia_driver/011-nvidia-450.80.02-${KERNVERS}.xzm ${BASEDIR}/
...
# VSCode needs RDL
if [ "${INCVSCODE}" == "Y" ]; then
  verbosecopymodule ${PACKAGESDIR}/vscode/vscode-1.50.1-${ARCH}-1.xzm ${MODSDIR}/
fi
