...
# Chrome needs RDL
if [ "${INCCHROME}" == "Y" ]; then
  verbosecopymodule ${PACKAGESDIR}/chrome/chrome-94.0.4606.81-x86_64-1.xzm ${MODSDIR}/
fi
...
verbosecopymodule ${PACKAGESDIR}/VirtualBox/VirtualBox-6.1.28-x86_64-1.xzm ${MODSDIR}/
