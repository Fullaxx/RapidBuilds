...
verbosecopymodule ${PACKAGESDIR}/nvidia_driver/011-nvidia-510.60.02-${KERNVERS}.xzm ${BASEDIR}/

# Chrome needs RDL
if [ "${INCCHROME}" == "Y" ]; then
  verbosecopymodule ${PACKAGESDIR}/chrome/chrome-100.0.4896.127-x86_64-1.xzm ${MODSDIR}/
fi
