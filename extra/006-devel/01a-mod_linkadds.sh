...
if [ "${INCCODEEXAMPLES}" == "Y" ]; then
  ...
  linkpackage "${PACKAGESDIR}/chorddhash/chorddhash-20181114-noarch-bksrc1.xzm"
  linkpackage "${PACKAGESDIR}/jnr-ffi/jnr-ffi-20181114-noarch-bksrc1.xzm"
  linkpackage "${PACKAGESDIR}/jshackle/jshackle-20181114-noarch-bksrc1.xzm"
  ...
  linkpackage "${PACKAGESDIR}/libtom/libtomcrypt-20181114-noarch-bksrc1.xzm"
